      ...
      <div class="about-content">
        ...
        <div class="about-text animate-on-scroll">
          ...
          <p class="about-subtitle">
            Профессиональный тренер по боксу, мастер спорта
          </p>

          <div class="about-description">
            <p>
              Приветствую вас на моём сайте! Я — Игорь Плаксин, профессиональный
              тренер по боксу с более чем 10-летним опытом работы. Моя
              спортивная карьера началась ещё в юности и привела меня к званию
              мастера спорта и множеству побед на соревнованиях различного
              уровня.
            </p>
            <p>
