...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      title: 'Игорь Плаксин - Профессиональный тренер по боксу в Липецке',
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          name: 'description',
          content:
            'Игорь Плаксин - сертифицированный тренер по боксу в Липецке. Индивидуальные и групповые тренировки, подготовка к соревнованиям для начинающих и профессионалов. Запишитесь на первое занятие!',
        },
        ...
        },
        {
          ...
          content:
            'Тренировки по боксу для всех уровней подготовки. Индивидуальные и групповые занятия с профессиональным тренером в Липецке.',
        },
